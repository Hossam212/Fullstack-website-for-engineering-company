...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"joinus.js":[function(require,module,exports) {
"use strict";
...
var joinTeam = /*#__PURE__*/function () {
  ...
  return function joinTeam(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.joinTeam = joinTeam;
},{"axios":"../../node_modules/axios/index.js"}],"contactUs.js":[function(require,module,exports) {
"use strict";
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, confirmPassword, phone) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
//DOM ELEMENTS
var appsform = document.querySelector('#apps_form');
...
if (appsform) {
  ...
  appsform.addEventListener('submit', function (e) {
    ...
    var firstName = document.querySelector('#name_input').value;
    var lastName = document.querySelector('#lastname_input').value;
    var email = document.querySelector('#email_input').value;
    var phone = document.querySelector('#telephone_input').value;
    var exp = document.querySelector('#subject_input').value;
    var diploma = document.querySelector('#diplomasubject_input').value;
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(name, email, password, confirmPassword, phone);
  });
}
},{"./joinus":"joinus.js","./contactUs":"contactUs.js","./login":"login.js","./signup":"signup.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12100" + '/');
